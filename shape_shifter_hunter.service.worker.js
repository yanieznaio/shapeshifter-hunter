...
/** @type {string} */
const CACHE_VERSION = '1769795860|2877169069';
/** @type {string} */
const CACHE_PREFIX = 'ggj-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'shape_shifter_hunter.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["shape_shifter_hunter.html","shape_shifter_hunter.js","shape_shifter_hunter.offline.html","shape_shifter_hunter.icon.png","shape_shifter_hunter.apple-touch-icon.png","shape_shifter_hunter.audio.worklet.js","shape_shifter_hunter.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["shape_shifter_hunter.wasm","shape_shifter_hunter.pck"];
